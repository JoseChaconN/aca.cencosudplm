                                                            ...
                                                            <div class="collapse" id="collapseCardProducto_2_{{$producto->id}}">
                                                                <div class="card-body">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <a class="btn btn-primary" href="{{ route('prospectos.importados.excel.planilla-solicitud',$producto->id) }}">Historial de cambios</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="card shadow mb-4">
                                                            ...
                                                            <div class="collapse" id="collapseCardProducto_3_{{$producto->id}}">
                                                                <div class="card-body">
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            <h6 class="mb-2 font-weight-bold text-primary">1.- Product Information</h6>
                                                                        </div>
                                                                        <div class="col-md-12">
                                                                            <table class="table table-bordered table-stripped table-hover table-sm">
                                                                                ...
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            <textarea rows="2" class="form-control" name="product_name_obs[{{$producto->id}}]" placeholder="Observaciones" style="resize: none">{{ $producto->obs->product_name }}</textarea>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td>
                                                                                ...
                                                                                <thead>
                                                                                    ...
                                                                                    <tbody>
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td><input type="text" class="form-control" name="salmonella[{{ $producto->id }}]" value="{{ $producto->salmonella }}"></td>
                                                                                            <td><textarea rows="2" class="form-control" name="salmonella_obs[{{ $producto->id }}]">{{ $producto->obs->salmonella }}</textarea></td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td>
                                                                                                E. Coli 0157 H7:
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td><input type="text" class="form-control" name="trichinella_spiralis[{{ $producto->id }}]" value="{{ $producto->trichinella_spiralis }}"></td>
                                                                                            <td><textarea rows="2" class="form-control" name="trichinella_spiralis_obs[{{ $producto->id }}]">{{ $producto->obs->trichinella_spiralis }}</textarea></td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td>
                                                                                                Lactobacillus:
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-sm-12">
                                                                                    <input type="text" class="form-control" name="esteroides[{{ $producto->id }}]" value="{{ $producto->esteroides }}">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
