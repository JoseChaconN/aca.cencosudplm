<x-layout>
    ...
    <div class="col-lg-12">
		<div class="card shadow ">
            ...
            <form method="POST" action="{{route('prospectos.store')}}" enctype="multipart/form-data">
                @csrf
                                ...
                                <div class="bs-stepper-content">
                                    <div id="test-l-1" class="content">
                                        ...
                                        <div class="col-md-12">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <h6 class="font-weight-bold text-primary">Responsable comercial proveedor
                                                ...
                                                <div class="col-md-12" id="contacto_comercial_" style="display: none">
                                                    ...
                                                    <button class="btn-danger btn-circle btn-sm btn-delete-contacto-comercial"><i class="fas fa-trash"></i></button>
                                                </div>
                                                    <div class="col-md-12">
                                            ...
                                            <div class="contacto-comercial-div row">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <hr class="sidebar-divider">
                                        ...
                                        <div class="col-md-12">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <h6 class="font-weight-bold text-primary">Responsable calidad proveedor
                                                ...
                                                <div class="col-md-12" id="contacto_calidad_" style="display: none">
                                                    ...
                                                    <button class="btn-danger btn-circle btn-sm btn-delete-contacto-calidad"><i class="fas fa-trash"></i></button>
                                                </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group row">
                                                            <label class="col-sm-4 col-form-label font-weight-bold">Nombre Contacto:</label>
                                            ...
                                            <div class="contacto-calidad-div row">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <hr class="sidebar-divider">
                                        ...
                                        <div class="col-md-12">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <h6 class="font-weight-bold text-primary">Plantas del proveedor
                                                ...
                                                <div class="col-md-12" id="producto_" style="display: none" >
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input type="text" class="form-control form-control-sm codigo_barra_producto" placeholder="Código de Barra" value="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <select class="marca_producto" data-live-search="true" title="Marca">
    ...
    <script>
        ...
        function fnAddMoreProducto() {
            ...
            clone.find('.codigo_barra_producto').attr('name','codigo_barra_producto[]');
