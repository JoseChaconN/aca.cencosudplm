    ...
    */
    ...
    public function collection(Collection $rows)
    {
        ...
        /////CALCULO DE TABLA NUTRICIONAL///////////
            ...
            $vitamin_a_100 = $rows->get(215)[2];
            $vitamin_c_100 = $rows->get(216)[2];
            $vitamin_d_100 = $rows->get(217)[2];
            $vitamin_e_100 = $rows->get(218)[2];
            $vitamin_b1_100 = $rows->get(219)[2];
            $vitamin_b2_100 = $rows->get(220)[2];
            $niacin_100 = $rows->get(221)[2];
            $vitamin_b6_100 = $rows->get(222)[2];
            $folic_acid_100 = $rows->get(223)[2];
            $vitamin_b12_100 = $rows->get(224)[2];
            $pantothenic_acid_100 = $rows->get(225)[2];
            $biotin_100 = $rows->get(226)[2];
            $choline_100 = $rows->get(227)[2];
            $vitamin_k_100 = $rows->get(228)[2];
            $betacarotene_100 = $rows->get(229)[2];
            $calcium_100 = $rows->get(231)[2];
            $chromium_100 = $rows->get(232)[2];
            $copper_100 = $rows->get(233)[2];
            $yodo_100 = $rows->get(234)[2];
            $iron_100 = $rows->get(235)[2];
            $magnesium_100 = $rows->get(236)[2];
            $manganese_100 = $rows->get(237)[2];
            $molybdenum_100 = $rows->get(238)[2];
            $phosphorus_100 = $rows->get(239)[2];
            $zinc_100 = $rows->get(240)[2];
            $selenium_100 = $rows->get(241)[2];
            $vitamin_a_serving = $rows->get(215)[3];
            $vitamin_c_serving = $rows->get(216)[3];
            $vitamin_d_serving = $rows->get(217)[3];
            $vitamin_e_serving = $rows->get(218)[3];
            $vitamin_b1_serving = $rows->get(219)[3];
            $vitamin_b2_serving = $rows->get(220)[3];
            $niacin_serving = $rows->get(221)[3];
            $vitamin_b6_serving = $rows->get(222)[3];
            $folic_acid_serving = $rows->get(223)[3];
            $vitamin_b12_serving = $rows->get(224)[3];
            $pantothenic_acid_serving = $rows->get(225)[3];
            $biotin_serving = $rows->get(226)[3];
            $choline_serving = $rows->get(227)[3];
            $vitamin_k_serving = $rows->get(228)[3];
            $betacarotene_serving = $rows->get(229)[3];
            $calcium_serving = $rows->get(231)[3];
            $chromium_serving = $rows->get(232)[3];
            $copper_serving = $rows->get(233)[3];
            $yodo_serving = $rows->get(234)[3];
            $iron_serving = $rows->get(235)[3];
            $magnesium_serving = $rows->get(236)[3];
            $manganese_serving = $rows->get(237)[3];
            $molybdenum_serving = $rows->get(238)[3];
            $phosphorus_serving = $rows->get(239)[3];
            $zinc_serving = $rows->get(240)[3];
            $selenium_serving = $rows->get(241)[3];
            if($serving_size > 0){
                #TABLA NUTRICIONAL
        ...
        $existingRecord->update([
            ...
            #NOVENA PARTE 2
                ...
                'energy_100_reconstitued' => $rows->get(191)[2],#NUEVA COLUMNA
                'proteins_100_reconstitued' => $rows->get(192)[2],#NUEVA COLUMNA
                'total_fat_100_reconstitued' => $rows->get(193)[2],#NUEVA COLUMNA
                'satured_fat_100_reconstitued' => $rows->get(194)[2],#NUEVA COLUMNA
                'trans_fat_100_reconstitued' => $rows->get(195)[2],#NUEVA COLUMNA
                'monosatured_fat_100_reconstitued' => $rows->get(196)[2],#NUEVA COLUMNA
                'polyunsatured_fat_100_reconstitued' => $rows->get(197)[2],#NUEVA COLUMNA
                'cholesterol_100_reconstitued' => $rows->get(198)[2],#NUEVA COLUMNA
                'total_carbohydrate_100_reconstitued' => $rows->get(199)[2],#NUEVA COLUMNA
                'available_carbohydrates_100_reconstitued' => $rows->get(200)[2],#NUEVA COLUMNA
                'total_sugars_100_reconstitued' => $rows->get(201)[2],#NUEVA COLUMNA
                'sucrose_100_reconstitued' => $rows->get(202)[2],#NUEVA COLUMNA
                'lactos_100_reconstitued' => $rows->get(203)[2],#NUEVA COLUMNA
                'poliols_100_reconstitued' => $rows->get(204)[2],#NUEVA COLUMNA
                'total_dietary_fiber_100_reconstitued' => $rows->get(205)[2],#NUEVA COLUMNA
                'soluble_fiber_100_reconstitued' => $rows->get(206)[2],#NUEVA COLUMNA
                'insoluble_fiber_100_reconstitued' => $rows->get(207)[2],#NUEVA COLUMNA
                'sodium_100_reconstitued' => $rows->get(208)[2],#NUEVA COLUMNA
                'energy_serving_reconstitued' => $rows->get(191)[3],#NUEVA COLUMNA
                'proteins_serving_reconstitued' => $rows->get(192)[3],#NUEVA COLUMNA
                'total_fat_serving_reconstitued' => $rows->get(193)[3],#NUEVA COLUMNA
                'satured_fat_serving_reconstitued' => $rows->get(194)[3],#NUEVA COLUMNA
                'trans_fat_serving_reconstitued' => $rows->get(195)[3],#NUEVA COLUMNA
                'monosatured_fat_serving_reconstitued' => $rows->get(196)[3],#NUEVA COLUMNA
                'polyunsatured_fat_serving_reconstitued' => $rows->get(197)[3],#NUEVA COLUMNA
                'cholesterol_serving_reconstitued' => $rows->get(198)[3],#NUEVA COLUMNA
                'total_carbohydrate_serving_reconstitued' => $rows->get(199)[3],#NUEVA COLUMNA
                'available_carbohydrates_serving_reconstitued' => $rows->get(200)[3],#NUEVA COLUMNA
                'total_sugars_serving_reconstitued' => $rows->get(201)[3],#NUEVA COLUMNA
                'sucrose_serving_reconstitued' => $rows->get(202)[3],#NUEVA COLUMNA
                'lactos_serving_reconstitued' => $rows->get(203)[3],#NUEVA COLUMNA
                'poliols_serving_reconstitued' => $rows->get(204)[3],#NUEVA COLUMNA
                'total_dietary_fiber_serving_reconstitued' => $rows->get(205)[3],#NUEVA COLUMNA
                'soluble_fiber_serving_reconstitued' => $rows->get(206)[3],#NUEVA COLUMNA
                'insoluble_fiber_serving_reconstitued' => $rows->get(207)[3],#NUEVA COLUMNA
                'sodium_serving_reconstitued' => $rows->get(208)[3],#NUEVA COLUMNA
                'energy_serving_reconstitued_r' => $rows->get(191)[4],#NUEVA COLUMNA
                'proteins_serving_reconstitued_r' => $rows->get(192)[4],#NUEVA COLUMNA
                'total_fat_serving_reconstitued_r' => $rows->get(193)[4],#NUEVA COLUMNA
                'satured_fat_serving_reconstitued_r' => $rows->get(194)[4],#NUEVA COLUMNA
                'trans_fat_serving_reconstitued_r' => $rows->get(195)[4],#NUEVA COLUMNA
                'monosatured_fat_serving_reconstitued_r' => $rows->get(196)[4],#NUEVA COLUMNA
                'polyunsatured_fat_serving_reconstitued_r' => $rows->get(197)[4],#NUEVA COLUMNA
                'cholesterol_serving_reconstitued_r' => $rows->get(198)[4],#NUEVA COLUMNA
                'total_carbohydrate_serving_reconstitued_r' => $rows->get(199)[4],#NUEVA COLUMNA
                'available_carbohydrates_serving_reconstitued_r' => $rows->get(200)[4],#NUEVA COLUMNA
                'total_sugars_serving_reconstitued_r' => $rows->get(201)[4],#NUEVA COLUMNA
                'sucrose_serving_reconstitued_r' => $rows->get(202)[4],#NUEVA COLUMNA
                'lactos_serving_reconstitued_r' => $rows->get(203)[4],#NUEVA COLUMNA
                'poliols_serving_reconstitued_r' => $rows->get(204)[4],#NUEVA COLUMNA
                'total_dietary_fiber_serving_reconstitued_r' => $rows->get(205)[4],#NUEVA COLUMNA
                'soluble_fiber_serving_reconstitued_r' => $rows->get(206)[4],#NUEVA COLUMNA
                'insoluble_fiber_serving_reconstitued_r' => $rows->get(207)[4],#NUEVA COLUMNA
                'sodium_serving_reconstitued_r' => $rows->get(208)[4],#NUEVA COLUMNA
            #DECIMA PARTE
