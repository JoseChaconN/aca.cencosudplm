...
<div class="row">
	<div class="col-lg-12">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
               	<form method="POST" action="{{ route('auditorias.pre_create')}}">
               		@csrf
					<div class="row">
               			<div class="col-md-4">
	                        ...
	                        <tbody>
	                        	@foreach($proveedores as $proveedor)
	                        		<tr>
		                                ...
		                                <td>{{$proveedor->rut}}</td>
		                                <td>
		                                	<a class="btn btn-primary btn-circle btn-sm" href="{{route('auditorias.new',$proveedor->id)}}"><i class="fa fa-check"></i></a>
		                                </td>
		                            </tr>
	                        	@endforeach	                        	
	                        </tbody>
