	...
	<div class="row">
		<div class="col-lg-12">
	        <div class="card shadow mb-4">
	            ...
	            <div class="card-body">
	               	<form method="POST" action="{{ route('plantas-proveedor.pre-create')}}">
	               		@csrf               		
						<div class="row">
	               			<div class="col-md-4">
		                        ...
		                        <tbody>
		                        	@foreach($proveedores as $item)
		                        		<tr>
                                            ...
                                            <td>{{$item->rut}}</td>
			                                <td>
			                                	<a class="btn btn-primary btn-circle btn-sm" href="{{route('plantas-proveedor.create',['id_proveedor' => $item->id])}}">
