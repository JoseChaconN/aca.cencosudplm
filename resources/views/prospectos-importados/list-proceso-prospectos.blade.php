		...
		<div class="col-lg-12">
	        ...
	        <div class="card shadow mb-4">
	            <div class="card-header py-3">
	                <h6 class="m-0 font-weight-bold text-primary">Listado de Prospectos en Proceso {{-- <a class="btn btn-primary" href="{{route('documentos.create')}}">Nueva Certificación</a> --}}</h6>
	            </div>
	            <div class="card-body">
                    @hasrole('comercial')
                        <div class="col-md-12">
                            <div class="col-lg-12 mb-4">
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-primary">Mis Prospectos Sin Notificar a Calidad</h6>
                                    </div>
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-striped table-hover dataTable" width="100%" cellspacing="0">
                                                ...
                                                <tbody>
                                                    @foreach($mis_prospectos_sin_notificar as $prospecto)
                                                        <tr>
