<x-layout>
	...
	<div class="row">
		{{-- <div class="col-lg-12">
	        <div class="card shadow mb-4">
	            <div class="card-header py-3">
	                <h6 class="m-0 font-weight-bold text-primary">Buscar Planta</h6>
	            </div>
	            <div class="card-body">
	               	<form method="POST" action="{{ route('plantas-proveedor.list')}}">
	               		@csrf               		
						<div class="row">
	               			<div class="col-md-4">
		...
		<div class="col-lg-12">
	        ...
	        <div class="card shadow mb-4">
	            <div class="card-header py-3">
	                <h6 class="m-0 font-weight-bold text-primary">Listado de plantas del proveedor <a class="btn btn-primary" href="{{route('plantas-proveedor.pre-create')}}">Nueva Planta</a></h6>
	            </div>
	            <div class="card-body">	            	
	            	<div class="col-md-12">
		            	<div class="col-md-12">
		                        ...
		                        <tbody>
		                        	@foreach($plantas as $item)
		                        		<tr>
			                                ...
			                                <td>
			                                	<a class="btn btn-primary btn-circle btn-sm" href="{{route('plantas-proveedor.edit',$item->id)}}">
